...
export default class CategoryScreen extends React.Component {
	...
	componentDidMount(){
        ...
        Object.keys(res.data.allCategoriesNested).forEach((key,index)=>{
          data.push({
            id: res.data.allCategoriesNested[key].id.toString()
          , key: res.data.allCategoriesNested[key].id.toString()
          , name: res.data.allCategoriesNested[key].name
          , data: res.data.allCategoriesNested[key].children.map( child => {
              return {
