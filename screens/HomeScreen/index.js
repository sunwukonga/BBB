...
import { Container, Content, List, ListItem, Text, Button, Icon, Item, Input, Fab } from 'native-base';
...
export default class HomeScreen extends React.Component {
    ...
    render() {
      var leftComponent = <Button transparent onPress={()=>this._handleMenu('DrawerOpen')}>
  								          <BBBIcon name="Menu" size={Layout.moderateScale(18)} color="#fff" style={{color: '#ffffff'}}/>
  												</Button>
          ...
          <Content style={styles.container}>
              <View>
                <View style={styles.searchSec}>
                  <Item regular style={styles.searchItem}>
                    <Input
                      ...
                      onSubmitEditing={()=>this.props.navigation.navigate('searchResultScreen')}
                      />
                ...
                <View style={styles.adSec}>
                  <Text style={styles.mainadText}>Do you have something to sell or give away?</Text>
                  <Text style={styles.subtitle}>Post it with us and we'll give you an audience.</Text>
                </View>

                <View style={styles.imagesMainView}>
                  <View style={styles.populerSec}>
                    <Text style={styles.populerText}>Your Recently Visited Items</Text>
                  </View>
                  <ListView
                    horizontal={true}
                    contentContainerStyle={styles.listContent}
