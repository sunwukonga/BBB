...
import {Image,Platform,ScrollView,StyleSheet,TouchableOpacity,View,ListView,TextInput} from 'react-native';
import { ActionSheet,Container, Text, Button, Icon, Item, Input } from 'native-base';
...
onClick(data) {
    ...
    return (
      <View style={styles.mainRowView}>
        ...
        <TouchableOpacity onPress ={ () => this._renderDeleteItem(rowData.id)}>
          <Ionicons name="md-close" size={Layout.moderateScale(15)} color='black'  style={styles.cancle}/>
        </TouchableOpacity>
      </View>
    )
  }
  ...
  onPressHeadSale  = () => {
    if(this.state.isCollapsedSale){
      this.setState({isCollapsedSale:false,isCollapsedBarter:true,isCollapsedDonate:true,isCollapsedDnS:true})
    }else{
  ...
  onPressHeadBarter  = () => {
    if(this.state.isCollapsedBarter){
      this.setState({isCollapsedSale:true,isCollapsedBarter:false,isCollapsedDonate:true,isCollapsedDnS:true})
    }else{
  ...
  onPressHeadDonate  = () => {
    if(this.state.isCollapsedDonate){
      this.setState({isCollapsedSale:true,isCollapsedBarter:true,isCollapsedDonate:false,isCollapsedDnS:true})
    }else{
  ...
  onPressHeadDnS  = () => {
    if(this.state.isCollapsedDnS){
      this.setState({isCollapsedSale:true,isCollapsedBarter:true,isCollapsedDonate:true,isCollapsedDnS:false})
    }else{
  ...
  render() {
   ...
   var temp = [
    ...
    return (
      ...
      <BBBHeader title="Create A New Item" leftComponent={ leftComponent } enableSearch />
        <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
          ...
          <View style={styles.exchangeMode}>
            ...
            <View style={styles.saleview}>
              <TouchableOpacity onPress={this.onPressHeadSale}>
                ...
                {(this.state.isCollapsedSale)?
                    <FontAwesome name="circle-o" color='black'  style={styles.redioDot}/>
                  :
                    <FontAwesome name="dot-circle-o" color='black'  style={styles.redioDot}/>
                }
                <Text style={styles.txtfacetoFace}>Sale</Text>
                </View>
              </TouchableOpacity>
              {(this.state.isCollapsedSale)? null:<View style={styles.bottomline}></View> }
              <Collapsible collapsed={this.state.isCollapsedSale}>
                ...
                rightTextStyle = {{color:'black', fontSize:20, marginLeft:20}}
                unCheckedImage={<Ionicons name="ios-square-outline" size={Layout.moderateScale(20)} color='black'  style={styles.cancle}/>}
                checkedImage={<Ionicons name="ios-checkbox-outline" size={Layout.moderateScale(20)} color='black'  style={styles.cancle}/>}
							  />
                </View>
              </Collapsible>
            </View>
            <View style={styles.saleview}>
              ...
              {(this.state.isCollapsedBarter)? null:<View style={styles.bottomline}></View> }
            ...
            <View style={styles.saleview}>
              ...
              {(this.state.isCollapsedDonate)? null:<View style={styles.bottomline}></View> }
              <Collapsible collapsed={this.state.isCollapsedDonate}>
                <View style={styles.saleChild}>
                <View style={styles.subFacetoFace}>
                  <View style={styles.dataFacetoFace}>
                    <Text style={styles.txtTitle}>71 Pilgrim Avenue Chevy Chase, MD 20815</Text>
            ...
            <View style={styles.saleview}>
              ...
              {(this.state.isCollapsedDnS)? null:<View style={styles.bottomline}></View> }
              <Collapsible collapsed={this.state.isCollapsedDnS}>
                ...
                <View style={styles.bottomlineShort}></View>
            ...
            <View style={styles.regPost}>
              ...
              <View style={styles.addmore}>
                <View style={styles.subAddmore}>
                  <Add width={Layout.HEIGHT*0.05} height={Layout.HEIGHT*0.05} />
          ...
          <View style={styles.Descrip}>
            ...
            <Item style={styles.txtInput} regular>
              <Input multiline={true} style={{ height:Layout.HEIGHT*0.1, backgroundColor: 'transparent', marginBottom: Layout.HEIGHT*0.015}} />
          ...
          <View style={styles.categoty}>
            <View style={styles.dataFacetoFace}>
              ...
              <View style={{flexDirection: 'row'}}>
                <Item style={styles.txtInputsmall} regular>
                  <Input onChangeText={(text) => {this.setState({textd :text}); }}/>
                </Item>
