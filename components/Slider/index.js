...
export default class Slider extends PureComponent {
  static propTypes = {
    ...
    /**
     * Sets an custom icon for the thumbImageComponent.
     */
    custom: PropTypes.bool,

    /**
     * Sets an icon for the thumbImageComponent.
     */
    thumbImageComponent: PropTypes.element,
  ...
  render() {
    ...
    var minimumTrackStyle = {
      position: 'absolute',
      width: Animated.add(thumbLeft, thumbSize.width / 3),
    ...
    return (
      <View {...other} style={[mainStyles.container, style]} onLayout={this._measureContainer}>
        <View
          ...
          <Animated.View
            renderToHardwareTextureAndroid={true}
            style={[mainStyles.track, trackStyle, minimumTrackStyle,{zIndex: 11}]} />
          <View style={{flexDirection: 'row', justifyContent: 'space-between',marginTop: 0, zIndex: 111}}>
            <View style={{zIndex: 111, backgroundColor: '#000', width: 4, height: 4, borderRadius: 2, marginLeft: 0.5}}></View>
            <View style={{zIndex: 111, backgroundColor: '#000', width: 4, height: 4, borderRadius: 2}}></View>
            <View style={{zIndex: 111, backgroundColor: '#000', width: 4, height: 4, borderRadius: 2}}></View>
            <View style={{zIndex: 111, backgroundColor: '#000', width: 4, height: 4, borderRadius: 2}}></View>
            <View style={{zIndex: 111, backgroundColor: '#000', width: 4, height: 4, borderRadius: 2, marginRight: 0.5}}></View>
          </View>
        </View>
        ...
        >
          {
            custom ? thumbImageComponent : this._renderThumbImage()
          }
        </Animated.View>
        <View
          renderToHardwareTextureAndroid={true}
